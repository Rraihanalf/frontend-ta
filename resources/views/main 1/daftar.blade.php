...
<body onload="AOS.init();">
  ...
  <div class="text-center mb-4">
    ...
    <form id="daftarForm" class="bg-light p-4 shadow-lg rounded animate__animated animate__fadeInUp" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-3">
          ...
          <input type="tel" class="form-control" id="no_handphone" required>
        </div>
        <div class="col-md-12 mb-3">
          <label for="email" class="form-label">Email Aktif</label>
          <input type="email" class="form-control" id="email_ortu" placeholder="contoh@email.com" required>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4 mb-3">
          ...
          <input type="file" class="form-control" id="kartu_keluarga" required>
        </div>
        <div class="col-md-4 mb-3">
          <label class="form-label">Akta Kelahiran</label>
          <input type="file" class="form-control" id="akta_lahir" required>
        </div>
        <div class="col-md-4 mb-3">
          <label class="form-label">Foto 3x4</label>
          <input type="file" class="form-control" id="pas_foto" required>
        </div>
      </div>
  ...
  <script>
    document.getElementById('daftarForm').addEventListener('submit', async function(e) {
      ...
      formData.append('nama_lengkap', document.querySelector('#daftarForm #nama_lengkap').value);
      formData.append('tempat_lahir', document.querySelector('#daftarForm #tempat_lahir').value);
      formData.append('tanggal_lahir', document.querySelector('#daftarForm #tanggal_lahir').value);
      formData.append('jenis_kelamin', document.querySelector('#daftarForm #jenis_kelamin').value); // Jenis kelamin
      formData.append('asal_tk', document.querySelector('#daftarForm #asal_tk').value);
      formData.append('alamat', document.querySelector('#daftarForm #alamat').value);
      formData.append('nama_ortu', document.querySelector('#daftarForm #nama_ortu').value);
      formData.append('no_handphone', document.querySelector('#daftarForm #no_handphone').value);
      formData.append('email_ortu', document.querySelector('#daftarForm #email_ortu').value);

      // File upload
      formData.append('kartu_keluarga', document.querySelector('#daftarForm #kartu_keluarga').files[0]);
      formData.append('akta_lahir', document.querySelector('#daftarForm #akta_lahir').files[0]);
      formData.append('pas_foto', document.querySelector('#daftarForm #pas_foto').files[0]);
    
      for (let pair of formData.entries()) {
        console.log(pair[0] + ': ' + pair[1]);
      }
      console.log(document.querySelector('#daftarForm #nama_lengkap')); 


      const baseUrl = 'http://127.0.0.1:8000/api/calon-siswas'; // Ganti sesuai endpoint pendaftaranmu
